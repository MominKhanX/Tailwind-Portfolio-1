...
export default function App() {
  ...
  const toggleSearchBar = () => {
    setSearchBarOpen(!isSearchBarOpen); // Toggle search bar visibility
  };
    ...
    <nav className="bg-white border-gray-200 dark:bg-gray-900">
      ...
      <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
        ...
        <a href="#" className="flex items-center space-x-3">
          <img src="/Sphere.png" className="h-8" alt="Logo" />
        ...
        <div className="flex md:order-2">
          ...
          <div className={`relative ${isSearchBarOpen ? "block" : "hidden"} md:block`}>
        ...
        <div className={`${isMenuOpen ? "block" : "hidden"} w-full md:flex md:w-auto md:order-1`} id="navbar-search">
          ...
          <ul className="flex flex-col p-4 md:p-0 mt-4 font-medium border border-gray-100 rounded-lg bg-gray-50 md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
            ...
            <li>
              <a href="#projects" className="block py-2 px-3 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-blue-700 md:p-0 dark:text-white md:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700">Projects</a>
            </li>

            <li>
              <a href="#testimonials" className="block py-2 px-3 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-blue-700 md:p-0 dark:text-white md:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700">Testimonials</a>
            </li>
