    ...
    <section className="w-full py-20">
      ...
      <div className="my-20 flex flex-col lg:flex-row items-center justify-center gap-4">
        ...
        <Card 
          ...
          description="Once we agree on the plan, I cue my music playlist and dive into coding.
                       From initial sketches to polished code, I keep you updated with every step of the way.">
          <CanvasRevealEffect
            animationSpeed={3}
    ...
    <div>
        <button className="p-[3px] relative">
            <div className="absolute inset-0 bg-gradient-to-r from-indigo-500 to-purple-500 rounded-lg" />
                <div className="px-8 py-2  bg-black rounded-[6px] font-bold relative group transition duration-200 text-2xl md:text-lg sm:text-sm text-white hover:bg-transparent">
                    {order}
                </div>
        </button>
    </div>
